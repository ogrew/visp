...
(defun print-help ()
  ...
  (format t "  --output <file>       Specify output filename~%")
  (format t "                        - If not specified, filename is auto-generated based on options~%")
  ...
  (format t "    - Output file will be named based on the first file + _merged.mp4 (or use --output)~%")
  ...
  (format t "    - Output file will be named like input.gif (e.g., movie.mp4 → movie.gif, or use --output)~%")
  (format t "    - Other options cannot be combined with --gif (except --output and --dry-run)~%")
